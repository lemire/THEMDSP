...
MV_Vector_double::MV_Vector_double(unsigned int n) : p_(new(std::nothrow) double[n]), dim_(n), 
            ref_(0)
{
    if (p_ == NULL)
    {
...
MV_Vector_double::MV_Vector_double(unsigned int n, const double& v) : 
        p_(new(std::nothrow) double[n]), dim_(n), ref_(0)
{
    if (p_ == NULL)
    {
        cerr << "Error: NULL pointer in MV_Vector_double(int) constructor " << endl;
...
MV_Vector_double& MV_Vector_double::newsize(unsigned int n)
{
    ...
    {                                   // the size of memory is really
        ...
        p_ = new(std::nothrow) double[n];              // copy in place.
        if (p_ == NULL)
        {
...
MV_Vector_double::MV_Vector_double(const MV_Vector_double & m) : p_(new(std::nothrow) double[m.dim_]), 
    dim_(m.dim_) , ref_(0)
{
    if (p_ == NULL)
    {
...
MV_Vector_double::MV_Vector_double(double* d, unsigned int n) : p_(new(std::nothrow) double[n]), 
      dim_(n) , ref_(0)
{
    if (p_ == NULL)
    {
...
MV_Vector_double::MV_Vector_double(const double* d, unsigned int n) : p_(new(std::nothrow) double[n]), 
      dim_(n) , ref_(0)
{
    if (p_ == NULL)
    {
